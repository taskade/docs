# Comprehensive Imported Articles Tables
...
- [Unpublished](#unpublished) (88 articles)
- [ai-agents](#ai-agents) (40 articles)
- [ai-automation](#ai-automation) (48 articles)
- [collaboration](#collaboration) (23 articles)
- [essentials](#essentials) (9 articles)
- [general](#general) (205 articles)
- [genesis](#genesis) (9 articles)
- [getting-started](#getting-started) (8 articles)
- [integrations](#integrations) (42 articles)
- [mobile](#mobile) (28 articles)
- [project-views](#project-views) (17 articles)
- [sharing](#sharing) (5 articles)
- [tasks](#tasks) (21 articles)
- [templates](#templates) (2 articles)
- [tips](#tips) (1 articles)
- [workspaces](#workspaces) (22 articles)
...
|-------|-------------|--------|------|
| A Guide to the New UI | What Is Taskade Genesis?Genesis is an AI app builder that generates complete business applicati... |  | help-center/_imported/Unpublished/a-guide-to-the-new-ui.md |
| A Maker's Guide to AI Prompts | OverviewAI prompts are the secret to building exactly what you envision. This guide will help y... |  | help-center/_imported/Unpublished/a-makers-guide-to-ai-prompts-1.md |
| A Maker's Guide to AI Prompts | Unlock Genesis's full potential with clear AI communication. | https://help.taskade.com/en/articles/11958560-a-maker-s-guide-to-ai-prompts | help-center/_imported/Unpublished/a-makers-guide-to-ai-prompts.md |
| Actionsheet View | OverviewThe Actionsheet view is one of the eight <a href=\"https://help.taskade.com/en/articles/... |  | help-center/_imported/Unpublished/actionsheet-view.md |
| Activity Feed (Mobile) | What Is the Activity Feed?The Activity Feed lets you view all personal and team notifications i... |  | help-center/_imported/Unpublished/activity-feed-mobile.md |
| Add Project to Agent Knowledge (Automation Action) \| Taskade Help Center | Imported from Taskade Help Center | https://help.taskade.com/en/articles/11410854-add-project-to-agent-knowledge-automation-action | help-center/_imported/Unpublished/add-project-to-agent-knowledge-automation-action.md |
| Add Task (Automation Action) \| Taskade Help Center | Imported from Taskade Help Center | https://help.taskade.com/en/articles/9787788-add-task | help-center/_imported/Unpublished/add-task.md |
| Adding Genesis Context | OverviewWhen you build apps with Genesis, you can upload reference files to provide context and... |  | help-center/_imported/Unpublished/adding-genesis-context.md |
| Agent (Automation Action) \| Taskade Help Center | Imported from Taskade Help Center | https://help.taskade.com/en/articles/8958471-agents | help-center/_imported/Unpublished/agents.md |
| Agent Knowledge & Memory \| Taskade Help Center | Imported from Taskade Help Center | https://help.taskade.com/en/articles/9495190-agent-knowledge-memory | help-center/_imported/Unpublished/agent-knowledge-memory.md |
| Agent Public Chat Ended (Automation Trigger) \| Taskade Help Center | Imported from Taskade Help Center | https://help.taskade.com/en/articles/10255741-agent-response-trigger | help-center/_imported/Unpublished/agent-response-trigger.md |
| Agent Tool (Automation Trigger) \| Taskade Help Center | Imported from Taskade Help Center | https://help.taskade.com/en/articles/9495506-agent-triggers | help-center/_imported/Unpublished/agent-triggers.md |
| AI Agent Knowledge Kit \| Taskade Help Center | Imported from Taskade Help Center | https://help.taskade.com/en/articles/10550328-ai-agent-knowledge-kit | help-center/_imported/Unpublished/ai-agent-knowledge-kit.md |
| AI Forms (Automation Trigger) \| Taskade Help Center | Imported from Taskade Help Center | https://help.taskade.com/en/articles/9711589-ai-forms | help-center/_imported/Unpublished/ai-forms.md |
| AI Team Generator | OverviewThe AI Team Generator lets you create entire multi-agent teams with a single prompt. Ju... |  | help-center/_imported/Unpublished/ai-team-generator.md |
| Ask Agent Team (Automation Action) | OverviewThe Ask Agent Team action allows you to send prompts to your existing <a href=\"https://help.ta... |  | help-center/_imported/Unpublished/ask-agent-team-automation-action.md |
| Ask Agent With Structured Output (Automation Action) \| Taskade Help Center | Imported from Taskade Help Center | https://help.taskade.com/en/articles/9994450-ask-agent-with-structured-output | help-center/_imported/Unpublished/ask-agent-with-structured-output.md |
| Assign Task (Automation Action) \| Taskade Help Center | Imported from Taskade Help Center | https://help.taskade.com/en/articles/9895835-assign-task-automation-action | help-center/_imported/Unpublished/assign-task-automation-action.md |
| Automation Actions \| Taskade Help Center | Imported from Taskade Help Center | https://help.taskade.com/en/articles/8958470-automation-actions | help-center/_imported/Unpublished/automation-actions.md |
| Automation Actions \| Taskade Help Center | Imported from Taskade Help Center | https://help.taskade.com/en/articles/8958470-actions | help-center/_imported/Unpublished/actions.md |
...
| Typeform Integration \| Taskade Help Center | Imported from Taskade Help Center | https://help.taskade.com/en/articles/9070719-typeform | help-center/_imported/Unpublished/typeform.md |
| Update Custom Fields (Automation Action) \| Taskade Help Center | Imported from Taskade Help Center | https://help.taskade.com/en/articles/9891133-update-custom-fields | help-center/_imported/Unpublished/update-custom-fields.md |
| Upload File to Media (Automation Action) \| Taskade Help Center | Imported from Taskade Help Center | https://help.taskade.com/en/articles/10111256-add-url-to-media | help-center/_imported/Unpublished/add-url-to-media.md |
| View and Manage Automations (Mobile) | OverviewAutomations for mobile is in Beta, supporting viewing and managing automations already ... |  | help-center/_imported/Unpublished/view-and-manage-automations-mobile.md |
| Webflow Integration \| Taskade Help Center | Imported from Taskade Help Center | https://help.taskade.com/en/articles/9100509-webflow | help-center/_imported/Unpublished/webflow.md |
| Webhooks (Automation Trigger) \| Taskade Help Center | Imported from Taskade Help Center | https://help.taskade.com/en/articles/9494976-webhooks | help-center/_imported/Unpublished/webhooks.md |
| WhatsApp Business Integration \| Taskade Help Center | Imported from Taskade Help Center | https://help.taskade.com/en/articles/10351275-whatsapp-integration | help-center/_imported/Unpublished/whatsapp-integration.md |
| WordPress Integration \| Taskade Help Center | Imported from Taskade Help Center | https://help.taskade.com/en/articles/8958481-wordpress | help-center/_imported/Unpublished/wordpress.md |
| Workflow Generator | The new Workflow Generator can think, branch, loop, filter, trigger, and act across your entire workflow ecosystem.... |  | help-center/_imported/Unpublished/workflow-generator.md |
| Your First Genesis Prompt | OverviewThe difference between a great app and something that barely works often comes down to ... |  | help-center/_imported/Unpublished/your-first-genesis-prompt.md |
| YouTube Integration \| Taskade Help Center | Imported from Taskade Help Center | https://help.taskade.com/en/articles/9787345-youtube-integration | help-center/_imported/Unpublished/youtube-integration.md |
...
| Title | Description | Source | Path |
|-------|-------------|--------|------|
| A Guide to the New UI | Navigating the New Taskade Layout | https://help.taskade.com/en/articles/11967139-a-guide-to-the-new-ui | help-center/_imported/ai-agents/a-guide-to-the-new-ui.md |
| Actionsheet View | Work in a simplified table interface designed for quick task management. | https://help.taskade.com/en/articles/11538404-actionsheet-view | help-center/_imported/ai-agents/actionsheet-view.md |
| Activity Feed (Mobile) | Stay updated on project changes and team activities on the go. | https://help.taskade.com/en/articles/11501337-activity-feed-mobile | help-center/_imported/ai-agents/activity-feed-mobile.md |
| Add Knowledge to Agent (Automation Action) | Automatically train your agents on knowledge from various sources. | https://help.taskade.com/en/articles/9994434-add-knowledge-to-agent-automation-action | help-center/_imported/ai-agents/add-knowledge-to-agent-automation-action.md |
| Add Project to Agent Knowledge (Automation Action) | Automatically train your AI agents with project content. | https://help.taskade.com/en/articles/11410854-add-project-to-agent-knowledge-automation-action | help-center/_imported/ai-agents/add-project-to-agent-knowledge-automation-action.md |
| Adding Genesis Context | Supercharge your apps with file-based context. | https://help.taskade.com/en/articles/12269139-adding-genesis-context | help-center/_imported/ai-agents/adding-genesis-context.md |
| Agent (Automation Action) | Use custom AI agents as part of your automation flows. | https://help.taskade.com/en/articles/8958471-agent-automation-action | help-center/_imported/ai-agents/agent-automation-action.md |
| Agent Knowledge & Memory | Train your agents to provide more customized, context-relevant responses. | https://help.taskade.com/en/articles/9495190-agent-knowledge-memory | help-center/_imported/ai-agents/agent-knowledge-memory.md |
| AI Agent Automation | Build advanced automation flows with your custom AI agents in the center. | https://help.taskade.com/en/articles/9314182-ai-agent-automation | help-center/_imported/ai-agents/ai-agent-automation.md |
| AI Agent Chat | Engage in discussions with your AI agents for tailored support. | https://help.taskade.com/en/articles/9380530-ai-agent-chat | help-center/_imported/ai-agents/ai-agent-chat.md |
| AI Agent Chat for Teams | Title: AI Agent Chat for Teams \| Taskade Help Center URL Source: https://help.taskade.com/en/articles/10085829-ai-agent-chat-for-teams Copyright (c) 2023, Intercom, Inc. (legal@intercom.io) with Reser... | https://help.taskade.com/en/articles/10085829-ai-agent-chat-for-teams | help-center/_imported/ai-agents/ai-agent-chat-for-teams.md |
| AI Agent Generator | Automatically generate custom AI agents for any task, project, or objective. | https://help.taskade.com/en/articles/9314104-ai-agent-generator | help-center/_imported/ai-agents/ai-agent-generator.md |
| AI Agent Knowledge Kit | Continuously expand an AI agent’s knowledge by automatically adding fresh resources to a dedicated project. | https://help.taskade.com/en/articles/10550328-ai-agent-knowledge-kit | help-center/_imported/ai-agents/ai-agent-knowledge-kit.md |
| AI Team Generator | Create fully-configured AI Teams instantly from a single prompt. | https://help.taskade.com/en/articles/11761479-ai-team-generator | help-center/_imported/ai-agents/ai-team-generator.md |
...
| Workflow Generator | Title: Workflow Generator \| Taskade Help Center URL Source: https://help.taskade.com/en/articles/11764179-workflow-generator Workflow Generator \| Taskade Help Center | https://help.taskade.com/en/articles/11764179-workflow-generator | help-center/_imported/ai-agents/workflow-generator.md |
...
| Title | Description | Source | Path |
|-------|-------------|--------|------|
| Add Task (Automation Action) | Create new tasks inside projects with the Add Task action. | https://help.taskade.com/en/articles/9787788-add-task-automation-action | help-center/_imported/ai-automation/add-task-automation-action.md |
...
| Categorize with AI (Automation Action) | Title: Categorize with AI (Automation Action) \| Taskade Help Center URL Source: https://help.taskade.com/en/articles/10857626-categorize-with-ai-automation-action | https://help.taskade.com/en/articles/10857626-categorize-with-ai-automation-action | help-center/_imported/ai-automation/categorize-with-ai-automation-action.md |
...
| Workflow Generator | Title: Workflow Generator \| Taskade Help Center URL Source: https://help.taskade.com/en/articles/11764179-workflow-generator Workflow Generator \| Taskade Help Center | https://help.taskade.com/en/articles/11764179-workflow-generator | help-center/_imported/ai-automation/workflow-generator-1.md |
| Zapier Integration | Connect Taskade with Zapier to integrate with third-party apps. | https://help.taskade.com/en/articles/8958540-zapier-integration | help-center/_imported/ai-automation/zapier-integration.md |
...
| Title | Description | Source | Path |
|-------|-------------|--------|------|
| AI Chat Personas | Assign expert personas to AI Chat for more tailored responses. | https://help.taskade.com/en/articles/8958464-ai-chat-personas | help-center/_imported/collaboration/ai-chat-personas.md |
| AI Chat Tones | Define the tone and style of responses in AI Chat conversations. | https://help.taskade.com/en/articles/8958463-ai-chat-tones | help-center/_imported/collaboration/ai-chat-tones.md |
| AI Team Generator | Create fully-configured AI Teams instantly from a single prompt. | https://help.taskade.com/en/articles/11761479-ai-team-generator | help-center/_imported/collaboration/ai-team-generator-8.md |
| AI Team Generator | Create fully-configured AI Teams instantly from a single prompt. | https://help.taskade.com/en/articles/11761479-ai-team-generator | help-center/_imported/collaboration/ai-team-generator-1.md |
| Asynchronous Collaboration | Title: Asynchronous Collaboration \| Taskade Help Center URL Source: https://help.taskade.com/en/articles/8958439-asynchronous-collaboration At Taskade, we believe that effective teams blend asynchrono... | https://help.taskade.com/en/articles/8958439-asynchronous-collaboration | help-center/_imported/collaboration/asynchronous-collaboration.md |
| Can I share an individual Project? | Find out how to share individual projects in Taskade. | https://help.taskade.com/en/articles/8958657-can-i-share-an-individual-project | help-center/_imported/collaboration/can-i-share-an-individual-project.md |
| Chat and Messaging | Communicate with your team in real-time using the chat feature. | https://help.taskade.com/en/articles/8958420-chat-and-messaging | help-center/_imported/collaboration/chat-and-messaging.md |
| Chat and Messaging (Mobile) | Communicate with your team in real-time using the chat feature. | https://help.taskade.com/en/articles/11456740-chat-and-messaging-mobile | help-center/_imported/collaboration/chat-and-messaging-mobile.md |
| Cloud Upload to Chat | Share files and documents to chat directly from your cloud storage services. | https://help.taskade.com/en/articles/8958444-cloud-upload-to-chat | help-center/_imported/collaboration/cloud-upload-to-chat.md |
| Contribute, Share, and Grow with Taskade | Join the Taskade community and discover how you can contribute. | https://help.taskade.com/en/articles/10577446-contribute-share-and-grow-with-taskade | help-center/_imported/collaboration/contribute-share-and-grow-with-taskade.md |
| How do I chat with a team member? | Learn how to use Taskade's chat feature to communicate with team members. | https://help.taskade.com/en/articles/8958640-how-do-i-chat-with-a-team-member | help-center/_imported/collaboration/how-do-i-chat-with-a-team-member.md |
| How to Chat on Taskade | Learn how to effectively use chat and messaging features. | https://help.taskade.com/en/articles/8958431-how-to-chat-on-taskade | help-center/_imported/collaboration/how-to-chat-on-taskade.md |
| Media AI Chat | Engage in AI-powered Q&A sessions with your files and documents. | https://help.taskade.com/en/articles/8958462-media-ai-chat | help-center/_imported/collaboration/media-ai-chat.md |
| Media AI Chat (Mobile) | Summarize and extract insights from docs. | https://help.taskade.com/en/articles/8958569-media-ai-chat-mobile | help-center/_imported/collaboration/media-ai-chat-mobile.md |
| Real-Time Collaboration | Title: Real-Time Collaboration \| Taskade Help Center URL Source: https://help.taskade.com/en/articles/8958440-real-time-collaboration **Collaborate in Real-Time** | https://help.taskade.com/en/articles/8958440-real-time-collaboration | help-center/_imported/collaboration/real-time-collaboration.md |
| Share a Project (Mobile) | Share you projects and add collaborators. | https://help.taskade.com/en/articles/8958561-share-a-project-mobile | help-center/_imported/collaboration/share-a-project-mobile.md |
| Share a Project / Add Collaborators | Share your project and add collaborators to work together seamlessly. | https://help.taskade.com/en/articles/8958373-share-a-project-add-collaborators | help-center/_imported/collaboration/share-a-project-add-collaborators.md |
| Share to Taskade Widget (Mobile) | Quickly add content to your projects. | https://help.taskade.com/en/articles/8958579-share-to-taskade-widget-mobile | help-center/_imported/collaboration/share-to-taskade-widget-mobile.md |
| Share with Password | Secure shared projects, agents, automations, and kits. | https://help.taskade.com/en/articles/8958442-share-with-password | help-center/_imported/collaboration/share-with-password.md |
| Start a Video Call | Initiate video calls directly from your Taskade projects. | https://help.taskade.com/en/articles/8958419-start-a-video-call | help-center/_imported/collaboration/start-a-video-call.md |
| Taskade AI Chat | Use the AI Chat for instant support, brainstorming, and problem-solving. | https://help.taskade.com/en/articles/8958451-taskade-ai-chat | help-center/_imported/collaboration/taskade-ai-chat.md |
| Taskade AI Chat (Mobile) | Get instant AI support within projects. | https://help.taskade.com/en/articles/8958568-taskade-ai-chat-mobile | help-center/_imported/collaboration/taskade-ai-chat-mobile.md |
| Turn Off Chat and Comments | Learn how to disable chat and comments for projects. | https://help.taskade.com/en/articles/8958436-turn-off-chat-and-comments | help-center/_imported/collaboration/turn-off-chat-and-comments.md |
...
| Title | Description | Source | Path |
|-------|-------------|--------|------|
| A Guide to the New UI | Navigating the New Taskade Layout | https://help.taskade.com/en/articles/11967139-a-guide-to-the-new-ui | help-center/_imported/essentials/a-guide-to-the-new-ui.md |
| Adding Genesis Context | Supercharge your apps with file-based context. | https://help.taskade.com/en/articles/12269139-adding-genesis-context | help-center/_imported/essentials/adding-genesis-context.md |
| Genesis App Gallery | Explore Genesis app examples with prompts and interactive demos. | https://help.taskade.com/en/articles/12123045-genesis-app-gallery | help-center/_imported/essentials/genesis-app-gallery.md |
| Genesis Version History | Track and restore previous versions of your Genesis apps. | https://help.taskade.com/en/articles/12269476-genesis-version-history | help-center/_imported/essentials/genesis-version-history.md |
| Guide to App Styles | If you can envision it, Genesis can build it. This guide covers the major visual style families with practical prompts and examples to help you create exactly the aesthetic you want. | https://help.taskade.com/en/articles/12166592-guide-to-app-styles | help-center/_imported/essentials/guide-to-app-styles.md |
| How Database Projects Work | Use projects that store, organize, and power your business applications. | https://help.taskade.com/en/articles/12166149-how-database-projects-work | help-center/_imported/essentials/how-database-projects-work.md |
| Prompt Library | Explore our prompt library and learn how to build and modify your apps. | https://help.taskade.com/en/articles/12037677-prompt-library | help-center/_imported/essentials/prompt-library.md |
| Publish and Clone Your Apps | Share your apps with the world and let others build on your ideas. | https://help.taskade.com/en/articles/12165353-publish-and-clone-your-apps | help-center/_imported/essentials/publish-and-clone-your-apps.md |
| Your First Genesis Prompt | Learn how to get your first app right on the first try. | https://help.taskade.com/en/articles/12068507-your-first-genesis-prompt | help-center/_imported/essentials/your-first-genesis-prompt.md |
...
| Title | Description | Source | Path |
|-------|-------------|--------|------|
| A Guide to the New UI | Navigating the New Taskade Layout | https://help.taskade.com/en/articles/11967139-a-guide-to-the-new-ui | help-center/_imported/general/a-guide-to-the-new-ui-1.md |
| A Maker's Guide to AI Prompts | Unlock Genesis's full potential with clear AI communication. | https://help.taskade.com/en/articles/11958560-a-maker-s-guide-to-ai-prompts | help-center/_imported/general/a-makers-guide-to-ai-prompts-1.md |
| A Maker's Guide to AI Prompts | Unlock Genesis's full potential with clear AI communication. | https://help.taskade.com/en/articles/11958560-a-maker-s-guide-to-ai-prompts | help-center/_imported/general/a-makers-guide-to-ai-prompts-7.md |
| Account Settings (Desktop) | Access and adjust your account settings. | https://help.taskade.com/en/articles/8958621-account-settings-desktop | help-center/_imported/general/account-settings-desktop.md |
| Activity Feed | Stay updated on project changes and team activities. | https://help.taskade.com/en/articles/8958424-activity-feed | help-center/_imported/general/activity-feed.md |
| Add Blocks | Add blocks to structure your project content into sections. | https://help.taskade.com/en/articles/8958528-add-blocks | help-center/_imported/general/add-blocks.md |
| AI Agents for Applicant Screening | Use custom AI agents to simplify hiring. Automate resume reviews, identify top candidates, and speed up the screening process. | https://help.taskade.com/en/articles/9227658-ai-agents-for-applicant-screening | help-center/_imported/general/ai-agents-for-applicant-screening.md |
| AI EEAT Blog Content Evaluator Kit | This kit helps evaluate your blog content against Google’s EEAT guidelines, providing a structured report with actionable insights. | https://help.taskade.com/en/articles/10532275-ai-eeat-blog-content-evaluator-kit | help-center/_imported/general/ai-eeat-blog-content-evaluator-kit.md |
| AI Email Campaign Kit | Manage promotional email campaigns, draft engaging messages with AI agents, and collaborate seamlessly with your team. | https://help.taskade.com/en/articles/10545069-ai-email-campaign-kit | help-center/_imported/general/ai-email-campaign-kit.md |
| AI Productivity Report Kit | Receive daily email updates with reports of completed tasks. | https://help.taskade.com/en/articles/10516029-ai-productivity-report-kit | help-center/_imported/general/ai-productivity-report-kit.md |
...
| Guide to App Styles | Title: Guide to App Styles \| Taskade Help Center URL Source: https://help.taskade.com/en/articles/12166592-guide-to-app-styles Guide to App Styles \| Taskade Help Center | https://help.taskade.com/en/articles/12166592-guide-to-app-styles | help-center/_imported/genesis/guide-to-app-styles-5.md |
| Prompt Library | Explore our prompt library and learn how to build and modify your apps. | https://help.taskade.com/en/articles/12037677-prompt-library | help-center/_imported/genesis/prompt-library-1.md |
| Taskade Genesis FAQ | Find answers to the most common Taskade Genesis questions. | https://help.taskade.com/en/articles/11963051-taskade-genesis-faq | help-center/_imported/genesis/taskade-genesis-faq-3.md |
| Your First Genesis Prompt | Learn how to get your first app right on the first try. | https://help.taskade.com/en/articles/12068507-your-first-genesis-prompt | help-center/_imported/genesis/your-first-genesis-prompt-1.md |
...
| Title | Description | Source | Path |
|-------|-------------|--------|------|
| Activity Feed (Mobile) | Stay updated on project changes and team activities on the go. | https://help.taskade.com/en/articles/11501337-activity-feed-mobile | help-center/_imported/getting-started/activity-feed-mobile.md |
| Guide to Taskade Mobile | Get started with Taskade's mobile apps. | https://help.taskade.com/en/articles/8958558-guide-to-taskade-mobile | help-center/_imported/getting-started/guide-to-taskade-mobile.md |
| How do I restore the New Tab? (Chrome, Firefox, Edge) | Learn how to restore default new tabs in your browsers. | https://help.taskade.com/en/articles/8958666-how-do-i-restore-the-new-tab-chrome-firefox-edge | help-center/_imported/getting-started/how-do-i-restore-the-new-tab-chrome-firefox-edge.md |
| How do I use Taskade? | Learn how to use Taskade effectively. | https://help.taskade.com/en/articles/8958645-how-do-i-use-taskade | help-center/_imported/getting-started/how-do-i-use-taskade.md |
| New Tab Browser Extension Settings (Firefox, Chrome, Edge) | Replace default new tabs in your web browser with Taskade. | https://help.taskade.com/en/articles/8958549-new-tab-browser-extension-settings-firefox-chrome-edge | help-center/_imported/getting-started/new-tab-browser-extension-settings-firefox-chrome-edge.md |
| Onboarding | Use Taskade to simplify your onboarding process. Automate new hire tracking, sending welcome emails/messages and requesting for hardware. | https://help.taskade.com/en/articles/10472809-onboarding | help-center/_imported/getting-started/onboarding.md |
| Start Here | Follow this easy, step-by-step guide to set up and start using Taskade like a pro. | https://help.taskade.com/en/articles/8958369-start-here | help-center/_imported/getting-started/start-here.md |
| View and Manage Automations (Mobile) | View and manage your automations on the go in Taskade Mobile. | https://help.taskade.com/en/articles/11461726-view-and-manage-automations-mobile | help-center/_imported/getting-started/view-and-manage-automations-mobile.md |
...
| Title | Description | Source | Path |
|-------|-------------|--------|------|
| AI Teams | Assign a group of agents to collaborate together. | https://help.taskade.com/en/articles/9586050-ai-teams | help-center/_imported/integrations/ai-teams.md |
| Apollo Integration | Use the Apollo integration to fetch additional details about leads. | https://help.taskade.com/en/articles/10856609-apollo-integration | help-center/_imported/integrations/apollo-integration.md |
| Box Integration | Download and embed files from your Box account. | https://help.taskade.com/en/articles/8958533-box-integration | help-center/_imported/integrations/box-integration.md |
| Calendar Feed Integration | Sync Taskade Calendar with Apple, Google, and Outlook calendars. | https://help.taskade.com/en/articles/8958537-calendar-feed-integration | help-center/_imported/integrations/calendar-feed-integration.md |
| Calendly Integration | Use the Calendly integration to manage appointments and calendar tasks. | https://help.taskade.com/en/articles/9070636-calendly-integration | help-center/_imported/integrations/calendly-integration.md |
| Discord Integration | Automate messages and enhance engagement with the Discord integration. | https://help.taskade.com/en/articles/10300035-discord-integration | help-center/_imported/integrations/discord-integration.md |
| Dropbox Integration | Download and embed files from your Dropbox account. | https://help.taskade.com/en/articles/8958534-dropbox-integration | help-center/_imported/integrations/dropbox-integration.md |
| Facebook Integration | Streamline and automate your social media with the Facebook integration. | https://help.taskade.com/en/articles/10350096-facebook-integration | help-center/_imported/integrations/facebook-integration.md |
| Generate LinkedIn and Facebook Posts from News Articles | Use Taskade to create engaging LinkedIn and Facebook posts from news articles, posting them automatically. | https://help.taskade.com/en/articles/10501670-generate-linkedin-and-facebook-posts-from-news-articles | help-center/_imported/integrations/generate-linkedin-and-facebook-posts-from-news-articles.md |
| GitHub Integration | Integrate and automate GitHub to streamline development workflows. | https://help.taskade.com/en/articles/10393224-github-integration | help-center/_imported/integrations/github-integration.md |
| Gmail Integration | Use the Gmail integration to streamline email workflows. | https://help.taskade.com/en/articles/8958474-gmail-integration | help-center/_imported/integrations/gmail-integration.md |
| Google Calendar Integration | Automatically manage your Google Calendar events from within Taskade. | https://help.taskade.com/en/articles/10098136-google-calendar-integration | help-center/_imported/integrations/google-calendar-integration.md |
| Google Calendar Sync | Sync Taskade Calendar with Google to manage your schedule and deadlines. | https://help.taskade.com/en/articles/8958536-google-calendar-sync | help-center/_imported/integrations/google-calendar-sync.md |
...
| Create & Use Templates (Mobile) | Make the most of the built-in templates. | https://help.taskade.com/en/articles/8958559-create-use-templates-mobile | help-center/_imported/mobile/create-use-templates-mobile.md |
| Create a Project (Mobile) | Learn how to create your first project. | https://help.taskade.com/en/articles/8958560-create-a-project-mobile | help-center/_imported/mobile/create-a-project-mobile.md |
| Edit & Format Projects (Mobile) | Master the project editor on iOS & Android. | https://help.taskade.com/en/articles/8958563-edit-format-projects-mobile | help-center/_imported/mobile/edit-format-projects-mobile.md |
| Hyperlinking (Mobile) | Add hyperlinks to tasks and projects. | https://help.taskade.com/en/articles/8958580-hyperlinking-mobile | help-center/_imported/mobile/hyperlinking-mobile.md |
| Is there an Android or an iOS mobile app for Taskade? | Find out more about Taskade's mobile apps for Android and iOS. | https://help.taskade.com/en/articles/8958668-is-there-an-android-or-an-ios-mobile-app-for-taskade | help-center/_imported/mobile/is-there-an-android-or-an-ios-mobile-app-for-taskade.md |
| Manage Tasks (Mobile) | Format tasks and use task add-ons. | https://help.taskade.com/en/articles/8958573-manage-tasks-mobile | help-center/_imported/mobile/manage-tasks-mobile.md |
| Mobile Quick Add Widget | Add tasks and projects from home screen. | https://help.taskade.com/en/articles/8958575-mobile-quick-add-widget | help-center/_imported/mobile/mobile-quick-add-widget.md |
| Mobile Widgets | Add and use mobile widgets to view and manage tasks directly from your home screen. | https://help.taskade.com/en/articles/8958577-mobile-widgets | help-center/_imported/mobile/mobile-widgets.md |
| Move / Copy Tasks (Mobile) | Relocate or duplicate tasks on iOS and Android. | https://help.taskade.com/en/articles/10368612-move-copy-tasks-mobile | help-center/_imported/mobile/move-copy-tasks-mobile.md |
| Project Backlinks (Mobile) | Connect related tasks and projects. | https://help.taskade.com/en/articles/8958562-project-backlinks-mobile | help-center/_imported/mobile/project-backlinks-mobile.md |
| Project Sorting (Mobile) | Sort your projects in a workspace for easy organization and access. | https://help.taskade.com/en/articles/11461494-project-sorting-mobile | help-center/_imported/mobile/project-sorting-mobile.md |
| Quick Add Widget | Use the Quick Add Widget to quickly add tasks and notes from your desktop. | https://help.taskade.com/en/articles/8958542-quick-add-widget | help-center/_imported/mobile/quick-add-widget.md |
| Reminders (Mobile) | Set reminders to keep track of deadlines. | https://help.taskade.com/en/articles/8958576-reminders-mobile | help-center/_imported/mobile/reminders-mobile.md |
| Taskade AI Assistant (Mobile) | Plan, write, and organize with AI. | https://help.taskade.com/en/articles/8958572-taskade-ai-assistant-mobile | help-center/_imported/mobile/taskade-ai-assistant-mobile.md |
| The Mobile App's toolbar is missing help! | Restore the missing toolbar in the Taskade mobile app. | https://help.taskade.com/en/articles/8958638-the-mobile-app-s-toolbar-is-missing-help | help-center/_imported/mobile/the-mobile-apps-toolbar-is-missing-help.md |
| Turn On Dark Mode (Mobile) | Enable dark mode to reduce eye strain. | https://help.taskade.com/en/articles/8958586-turn-on-dark-mode-mobile | help-center/_imported/mobile/turn-on-dark-mode-mobile.md |
| Undo / Redo (Mobile) | Undo or redo actions in the project editor. | https://help.taskade.com/en/articles/8958581-undo-redo-mobile | help-center/_imported/mobile/undo-redo-mobile.md |
| Upload Files / Attachments (Mobile) | Upload files and attachments to tasks and projects for easy reference. | https://help.taskade.com/en/articles/11456283-upload-files-attachments-mobile | help-center/_imported/mobile/upload-files-attachments-mobile.md |
| View and Manage Automations (Mobile) | View and manage your automations on the go in Taskade Mobile. | https://help.taskade.com/en/articles/11461726-view-and-manage-automations-mobile | help-center/_imported/mobile/view-and-manage-automations-mobile-1.md |
| Why are some Mobile Widgets no longer supported? | Understand Taskade's new mobile widgets | https://help.taskade.com/en/articles/10026055-why-are-some-mobile-widgets-no-longer-supported | help-center/_imported/mobile/why-are-some-mobile-widgets-no-longer-supported.md |
...
| Title | Description | Source | Path |
|-------|-------------|--------|------|
| Actionsheet View | Work in a simplified table interface designed for quick task management. | https://help.taskade.com/en/articles/11538404-actionsheet-view | help-center/_imported/project-views/actionsheet-view-2.md |
| Actionsheet View | Work in a simplified table interface designed for quick task management. | https://help.taskade.com/en/articles/11538404-actionsheet-view | help-center/_imported/project-views/actionsheet-view-1.md |
| Board / Kanban View | Visualize your workflow with the Board view, inspired by Kanban. | https://help.taskade.com/en/articles/8958387-board-kanban-view | help-center/_imported/project-views/board-kanban-view.md |
| Calendar View | See all your deadlines and important dates in a single layout with the Calendar view. | https://help.taskade.com/en/articles/8958388-calendar-view | help-center/_imported/project-views/calendar-view.md |
| Content Calendar | Use Taskade to create and manage your content calendar. Plan your content, schedule publishing dates, and track progress all in one place. | https://help.taskade.com/en/articles/8958677-content-calendar | help-center/_imported/project-views/content-calendar.md |
| Create Your First App | Your First App in 5 Minutes with Taskade Genesis. | https://help.taskade.com/en/articles/11957643-create-your-first-app | help-center/_imported/project-views/create-your-first-app.md |
| Export as Org Chart | Export your Taskade projects as organizational charts to visualize hierarchies. | https://help.taskade.com/en/articles/8958616-export-as-org-chart | help-center/_imported/project-views/export-as-org-chart.md |
| Export to Mind Map | Export your Taskade projects to a mind map for visual organization. | https://help.taskade.com/en/articles/8958611-export-to-mind-map | help-center/_imported/project-views/export-to-mind-map.md |
| Fill with AI (Table View) | Leverage AI to automatically fill up columns in the Table View. | https://help.taskade.com/en/articles/11721113-fill-with-ai-table-view | help-center/_imported/project-views/fill-with-ai-table-view-1.md |
| Fill with AI (Table View) | Leverage AI to automatically fill up columns in the Table View. | https://help.taskade.com/en/articles/11721113-fill-with-ai-table-view | help-center/_imported/project-views/fill-with-ai-table-view-2.md |
| Gantt Chart View | Plan and visualize your project timeline with the Gantt Chart view. | https://help.taskade.com/en/articles/9072639-gantt-chart-view | help-center/_imported/project-views/gantt-chart-view.md |
| List View / Outline | Organize your tasks in a structured, hierarchical format with the List view. | https://help.taskade.com/en/articles/8958386-list-view-outline | help-center/_imported/project-views/list-view-outline.md |
| Mind Map View | Connect ideas and tasks visually to brainstorm and plan projects in an intuitive way. | https://help.taskade.com/en/articles/8958390-mind-map-view | help-center/_imported/project-views/mind-map-view.md |
| Org Chart View | Visualize team roles and relationships with the Org Chart view. | https://help.taskade.com/en/articles/8958391-org-chart-view | help-center/_imported/project-views/org-chart-view.md |
| Table View | Unlock a spreadsheet-like experience for detailed project management. | https://help.taskade.com/en/articles/8958389-table-view | help-center/_imported/project-views/table-view.md |
| Taskade Calendar | Schedule tasks, set deadlines, and track project timelines in one place. | https://help.taskade.com/en/articles/8958375-taskade-calendar | help-center/_imported/project-views/taskade-calendar.md |
| Troubleshooting Your App | When your app needs adjustments, here's how to get it just right. | https://help.taskade.com/en/articles/11972868-troubleshooting-your-app | help-center/_imported/project-views/troubleshooting-your-app.md |
...
| Title | Description | Source | Path |
|-------|-------------|--------|------|
| Change / Reset Taskade Password | Learn how to change or reset your Taskade password. | https://help.taskade.com/en/articles/8958622-change-reset-taskade-password | help-center/_imported/sharing/change-reset-taskade-password.md |
| Embed Media | Embed media such as videos and images directly into your projects. | https://help.taskade.com/en/articles/8958518-embed-media | help-center/_imported/sharing/embed-media.md |
| Embed Taskade | Embed Taskade projects into your website or blog. | https://help.taskade.com/en/articles/8958448-embed-taskade | help-center/_imported/sharing/embed-taskade.md |
| Publish a Project | Share your projects online for wider access and visibility. | https://help.taskade.com/en/articles/8958447-publish-a-project | help-center/_imported/sharing/publish-a-project.md |
| Publish and Clone Your Apps | Share your apps with the world and let others build on your ideas. | https://help.taskade.com/en/articles/12165353-publish-and-clone-your-apps | help-center/_imported/sharing/publish-and-clone-your-apps-2.md |
...
| Title | Description | Source | Path |
|-------|-------------|--------|------|
| Add Task / Subtask | Add tasks and sub-tasks to organize your projects. | https://help.taskade.com/en/articles/8958371-add-task-subtask | help-center/_imported/tasks/add-task-subtask.md |
| Assign a Project / Task | Title: Assign a Project / Task \| Taskade Help Center URL Source: https://help.taskade.com/en/articles/8958438-assign-a-project-task Updated over a year ago | https://help.taskade.com/en/articles/8958438-assign-a-project-task | help-center/_imported/tasks/assign-a-project-task.md |
| Complete / Delete a Project | Complete, archive, or delete projects to manage your workspace. | https://help.taskade.com/en/articles/8958517-complete-delete-a-project | help-center/_imported/tasks/complete-delete-a-project.md |
| Complete / Delete a Project (Mobile) | Complete, archive, or delete projects to manage your workspace. | https://help.taskade.com/en/articles/11430854-complete-delete-a-project-mobile | help-center/_imported/tasks/complete-delete-a-project-mobile.md |
| Duplicate Task / Block / Section | Duplicate tasks, blocks, or sections to build projects faster. | https://help.taskade.com/en/articles/8958415-duplicate-task-block-section | help-center/_imported/tasks/duplicate-task-block-section.md |
| How do I assign / unassign a task? | Title: How do I assign / unassign a task? \| Taskade Help Center URL Source: https://help.taskade.com/en/articles/8958659-how-do-i-assign-unassign-a-task | https://help.taskade.com/en/articles/8958659-how-do-i-assign-unassign-a-task | help-center/_imported/tasks/how-do-i-assign-unassign-a-task.md |
| I deleted projects but their tasks still show up in My Tasks, help! | Fix the issue of deleted project tasks still appearing in \"My Tasks.\ | https://help.taskade.com/en/articles/8958637-i-deleted-projects-but-their-tasks-still-show-up-in-my-tasks-help | help-center/_imported/tasks/i-deleted-projects-but-their-tasks-still-show-up-in-my-tasks-help.md |
| Link to Task | Generate links to specific tasks for quick reference and sharing. | https://help.taskade.com/en/articles/8958446-link-to-task | help-center/_imported/tasks/link-to-task.md |
| Multi-Select / Bulk Assign Tasks | Assign multiple tasks to team members at once. | https://help.taskade.com/en/articles/8958523-multi-select-bulk-assign-tasks | help-center/_imported/tasks/multi-select-bulk-assign-tasks.md |
| My Tasks | View and manage all your assigned tasks in one place. | https://help.taskade.com/en/articles/8958383-my-tasks | help-center/_imported/tasks/my-tasks.md |
| My tasks are not showing on the Roadmap. What can I do? | Troubleshoot issues with tasks not appearing on the roadmap. | https://help.taskade.com/en/articles/8958665-my-tasks-are-not-showing-on-the-roadmap-what-can-i-do | help-center/_imported/tasks/my-tasks-are-not-showing-on-the-roadmap-what-can-i-do.md |
| Recurring Tasks | Set up recurring tasks in Taskade to automate repetitive activities. | https://help.taskade.com/en/articles/8958441-recurring-tasks | help-center/_imported/tasks/recurring-tasks.md |
| Recurring Tasks (Mobile) | Set up recurring tasks. | https://help.taskade.com/en/articles/8958582-recurring-tasks-mobile | help-center/_imported/tasks/recurring-tasks-mobile.md |
| Reorder Task/Block/Column | Rearrange tasks, blocks, and columns to prioritize and organize your projects. | https://help.taskade.com/en/articles/8958414-reorder-task-block-column | help-center/_imported/tasks/reorder-taskblockcolumn.md |
| Set a Due Date (Mobile) | Set due dates for tasks. | https://help.taskade.com/en/articles/8958574-set-a-due-date-mobile | help-center/_imported/tasks/set-a-due-date-mobile.md |
| Task Add-Ons | Enhance projects with add-ons including AI agents, comments, and more. | https://help.taskade.com/en/articles/8958443-task-add-ons | help-center/_imported/tasks/task-add-ons.md |
| Task Completion History | Keep track of completed tasks and their history. | https://help.taskade.com/en/articles/8958427-task-completion-history | help-center/_imported/tasks/task-completion-history.md |
| Task Reactions | Add reactions to tasks to provide quick feedback or acknowledge updates. | https://help.taskade.com/en/articles/8958522-task-reactions | help-center/_imported/tasks/task-reactions.md |
| Task Sorting | Organize tasks using various sorting options. | https://help.taskade.com/en/articles/8958417-task-sorting | help-center/_imported/tasks/task-sorting.md |
| Task Time Stamp | Keep track of task activity with time stamps. | https://help.taskade.com/en/articles/8958418-task-time-stamp | help-center/_imported/tasks/task-time-stamp.md |
| Taskade for Note-Taking | Use Taskade for personal and business notes. Draft documents, organize with folders and tags, and collaborate in real-time. | https://help.taskade.com/en/articles/8958684-taskade-for-note-taking | help-center/_imported/tasks/taskade-for-note-taking.md |
...
| Title | Description | Source | Path |
|-------|-------------|--------|------|
| Share a Template | Simplify project initiation by sharing pre-designed templates with your team. | https://help.taskade.com/en/articles/8958397-share-a-template | help-center/_imported/templates/share-a-template.md |
| Template Gallery | Find the perfect starting point for your next project. | https://help.taskade.com/en/articles/8958395-template-gallery | help-center/_imported/templates/template-gallery.md |
...
| Title | Description | Source | Path |
|-------|-------------|--------|------|
| Workflow Generator | The new **Workflow Generator** can **think, branch, loop, filter, trigger, and act** across your entire workflow ecosystem. Chat with it to build complex automation instantly—you can now create, edit,... | https://help.taskade.com/en/articles/11764179-workflow-generator | help-center/_imported/tips/workflow-generator.md |
...
| Title | Description | Source | Path |
|-------|-------------|--------|------|
| Change Workspace Color & Icon | Customize your workspace with unique colors and icons. | https://help.taskade.com/en/articles/8958492-change-workspace-color-icon | help-center/_imported/workspaces/change-workspace-color-icon.md |
| Create a Team (Folder) | Create Teams within a workspace to organize related projects. | https://help.taskade.com/en/articles/8958495-create-a-team-folder | help-center/_imported/workspaces/create-a-team-folder.md |
| Create a Workspace | Create a new workspace to organize your projects and collaborate with your team. | https://help.taskade.com/en/articles/8958483-create-a-workspace | help-center/_imported/workspaces/create-a-workspace.md |
| Customize Workspace (Mobile) | Personalize your Taskade workspace. | https://help.taskade.com/en/articles/8958583-customize-workspace-mobile | help-center/_imported/workspaces/customize-workspace-mobile.md |
| Edit a Workspace | Edit workspace details and security settings. | https://help.taskade.com/en/articles/8958485-edit-a-workspace | help-center/_imported/workspaces/edit-a-workspace.md |
| How do I invite someone to join my Workspace? | Find out how to invite new members to your Taskade workspace. | https://help.taskade.com/en/articles/8958654-how-do-i-invite-someone-to-join-my-workspace | help-center/_imported/workspaces/how-do-i-invite-someone-to-join-my-workspace.md |
| How do I transfer Workspace ownership? | Learn how to transfer ownership of a Taskade workspace. | https://help.taskade.com/en/articles/8958656-how-do-i-transfer-workspace-ownership | help-center/_imported/workspaces/how-do-i-transfer-workspace-ownership.md |
| How many video chat participants / workspace members can I invite? | Find out the limits on video chat participants and workspace members in Taskade. | https://help.taskade.com/en/articles/8958651-how-many-video-chat-participants-workspace-members-can-i-invite | help-center/_imported/workspaces/how-many-video-chat-participants-workspace-members-can-i-invite.md |
| Invite to a Workspace | Invite new members to join your workspace for collaborative project management. | https://help.taskade.com/en/articles/8958486-invite-to-a-workspace | help-center/_imported/workspaces/invite-to-a-workspace.md |
| Manage a Folder | Manage folder settings and contents to keep your projects organized. | https://help.taskade.com/en/articles/8958496-manage-a-folder | help-center/_imported/workspaces/manage-a-folder.md |
| Manage a Folder (Mobile) | Create and manage folders. | https://help.taskade.com/en/articles/8958566-manage-a-folder-mobile | help-center/_imported/workspaces/manage-a-folder-mobile.md |
| Manage a Workspace | Add or remove workspace members and set permissions. | https://help.taskade.com/en/articles/8958484-manage-a-workspace | help-center/_imported/workspaces/manage-a-workspace.md |
| Manage a Workspace (Mobile) | Create and manage workspaces. | https://help.taskade.com/en/articles/8958565-manage-a-workspace-mobile | help-center/_imported/workspaces/manage-a-workspace-mobile.md |
| Set Default Workspace / Reorder Workspaces | Set a default workspace to streamline your workflow and improve organization. | https://help.taskade.com/en/articles/8958491-set-default-workspace-reorder-workspaces | help-center/_imported/workspaces/set-default-workspace-reorder-workspaces.md |
| Share a Team (Folder) | Share Teams (Folders) with other Taskade users to collaborate. | https://help.taskade.com/en/articles/8958494-share-a-team-folder | help-center/_imported/workspaces/share-a-team-folder.md |
| Team (Folder) Permissions | Set and manage permissions for teams to control access. | https://help.taskade.com/en/articles/8958493-team-folder-permissions | help-center/_imported/workspaces/team-folder-permissions.md |
| What is a Workspace? | Understand how to create, manage, and use workspaces. | https://help.taskade.com/en/articles/8958652-what-is-a-workspace | help-center/_imported/workspaces/what-is-a-workspace.md |
| What is the difference between a Workspace and a Team (Folder)? | Understand the difference between workspaces and teams in Taskade. | https://help.taskade.com/en/articles/8958655-what-is-the-difference-between-a-workspace-and-a-team-folder | help-center/_imported/workspaces/what-is-the-difference-between-a-workspace-and-a-team-folder.md |
| Workspace / Team Tags | Use tags to categorize and filter projects within your workspace or teams. | https://help.taskade.com/en/articles/8958487-workspace-team-tags | help-center/_imported/workspaces/workspace-team-tags.md |
| Workspace Navigation Tabs | Move between different sections of your workspace using navigation tabs. | https://help.taskade.com/en/articles/8958488-workspace-navigation-tabs | help-center/_imported/workspaces/workspace-navigation-tabs.md |
| Workspace Tags (Mobile) | Organize your workspace with tags. | https://help.taskade.com/en/articles/8958564-workspace-tags-mobile | help-center/_imported/workspaces/workspace-tags-mobile.md |
| Workspace Tasks Tab | Manage and view all tasks within your workspace in the Tasks tab. | https://help.taskade.com/en/articles/8958490-workspace-tasks-tab | help-center/_imported/workspaces/workspace-tasks-tab.md |
