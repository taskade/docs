...
- [The Tree of Life Architecture](#the-tree-of-life-architecture)
  - [Memory: Projects & Databases](#memory-projects--databases)
  - [Intelligence: Custom AI Agents](#intelligence-custom-ai-agents)
  - [Execution: Automations & Integrations](#execution-automations--integrations)
...
- [Kits & Bundles](#kits--bundles-package-your-entire-workspace)
