---
description: The official Taskade TypeScript SDK — a lightweight, type-safe client for the Taskade API. Coming soon to npm.
---
...
See the full [REST API Reference](developers/api.md) and [Comprehensive API Guide](comprehensive-api-guide/README.md) for all available endpoints.
...
| [Automations](../genesis-living-system-builder/automation/README.md) | No-code workflow automation |
...
- The [Taskade changelog](../updates-and-timeline/march-2026/README.md)
