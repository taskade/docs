...
| ----- | -------- | ---- | ----- |
| Gemma 4 31B | Google | Small | Instruction-tuned |
| Gemma 4 26B A4B | Google | Small | Mixture-of-experts variant |
| Qwen 3.6 Plus | Alibaba | Advanced | Replaces Qwen 3 in the picker |
| MiniMax M2.7 | MiniMax | Advanced | Coding, security, and debugging |
| GLM 5.1 | Z.AI | Advanced | |

**Model picker updates:**

* Default model selections were refreshed across plan tiers.
* GPT-5.4 mini and GPT-5.4 nano are now selectable for standard and lightweight use respectively.
* Gemini 3.1 Flash Lite replaces Gemini 2.5 Flash Lite in the picker's Small tier.
